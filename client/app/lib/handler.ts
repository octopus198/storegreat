...
//       cookieStore.set("accessToken", newTokens.access_token, { httpOnly: true });
//       cookieStore.set("refreshToken", newTokens.refresh_token, { httpOnly: true });
...
//     const responseData = await response.json();
//     return responseData.tokens; // Return only tokens
//   } catch (error) {
//     throw new Error("Database Error: Failed to refresh token.");
//   }
// }